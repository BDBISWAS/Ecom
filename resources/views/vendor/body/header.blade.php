        ...
        <p class="msg-info">Your new product has approved</p>
          ...
          <div class="user-box dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li><a class="dropdown-item" href="{{route('vendor.dashobard')}}"><i class='bx bx-home-circle'></i><span>Dashboard</span></a>
              </li>
              ...
              <li><a class="dropdown-item" href="{{route('vendor.destroy')}}"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
              </li>
            </ul>
